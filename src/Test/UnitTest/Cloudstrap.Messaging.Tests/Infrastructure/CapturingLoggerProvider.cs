namespace Cloudstrap.Messaging.Tests.Infrastructure
{
    ...
    /// <summary>
    /// A logger provider recording everything written through it, so a test can assert on what the node
    /// logged — the one-line startup summary, or that a payload never appears.
    /// </summary>
